...
start cmd /k "java -jar ./config-client/target/config-client-1.0-SNAPSHOT.jar --server.port=7002"
start cmd /k "java -jar ./config-client/target/config-client-1.0-SNAPSHOT.jar --server.port=7003"