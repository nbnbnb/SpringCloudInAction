...
rem start cmd /k "java -jar ./stream-producer/target/stream-producer-1.0-SNAPSHOT.jar"
rem start cmd /k "java -jar ./stream-consumer/target/stream-consumer-1.0-SNAPSHOT.jar --spring.cloud.stream.instanceIndex=0"
rem start cmd /k "java -jar ./stream-consumer/target/stream-consumer-1.0-SNAPSHOT.jar --spring.cloud.stream.instanceIndex=1"
